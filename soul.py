...
bot = telebot.TeleBot('7860510784:AAEIOO8M4b_sDbKtwEgyQW5udYkEav6vmO0')
...
def add_user(message):
    ...
    if user_id in admin_id:
        ...
        response = "Mood ni hai abhi pelhe purchase kar isse:- @DKiHUNT."
...
 Usage: /remove <userid>'''
        ...
        response = "Purchase karle bsdk:- @DKiHUNT ."
...
def welcome_start(message):
    ...
    response = f'''🔥DK ke LODE pe aapka swagat hai, {user_name}! Sabse acche se bgmi ki maa behen yahi hack karta hai. Kharidne ke liye Kira se sampark karein.
